...
\hypersetup{
  pdftitle={Zero-Free Invariant Characters under Coprime Action: A Counterexample},
  pdfauthor={Eric Hou}
}
...
\title{Zero-Free Invariant Characters under Coprime Action: A Counterexample}
\author{Eric Hou}
\date{}
